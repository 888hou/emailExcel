...
class PageHandler {
    ...
    bindEvent() {
        ...
        document.querySelector('#xlf').addEventListener('change', self.handleFile.call(self), false);

        document.querySelector('#submit').addEventListener('click', self.handleSubmit.call(self), false);

        document.querySelector('#email').addEventListener('click', self.handleInput.call(self), false);

        document.querySelector('#password').addEventListener('click', self.handleInput.call(self), false);
